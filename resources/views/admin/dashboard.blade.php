    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="p-6 bg-white rounded-3xl border border-yellow-100 shadow-sm hover:shadow-md transition">
            <div class="flex items-center justify-between">
                ...
                <div class="w-12 h-12 flex items-center justify-center rounded-2xl bg-green-200 text-xl">
                    👤
                </div>
            </div>
        </div>
        ...
        <div class="p-6 bg-white rounded-3xl border border-yellow-100 shadow-sm hover:shadow-md transition">
            <div class="flex items-center justify-between">
                ...
                <div class="w-12 h-12 flex items-center justify-center rounded-2xl bg-purple-200 text-xl">
                    🧑‍💼
                </div>
            </div>
        </div>
