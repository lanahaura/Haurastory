@extends('admin.layout', ['title' => 'Laporan'])
...
<div class="bg-white rounded-2xl border border-yellow-100 shadow-sm p-4">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        ...
        <form method="GET" action="{{ route('admin.reports.index') }}" class="flex flex-col md:flex-row gap-2">
            <div>
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="{{ route('admin.reports.pdf', ['from' => $from, 'to' => $to]) }}"
                   class="px-4 py-2 rounded-xl bg-yellow-200 hover:bg-yellow-300 font-bold text-sm">
                   Export PDF
                </a>
