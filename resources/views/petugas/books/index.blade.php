@extends('petugas.layout', ['title' => 'Data Buku'])
            ...
            @forelse($books as $b)
                <tr class="border-t hover:bg-yellow-50">
                    ...
                    <td class="p-3">
                        ...
                        <div class="text-xs text-gray-600">ID: {{ $b->id }}</div>
                    </td>
                    ...
                    <td class="p-3">
                        <div class="flex justify-center gap-2">
                            <a href="{{ route('petugas.books.edit', $b) }}"
                               class="px-3 py-2 rounded-xl bg-yellow-300 hover:bg-yellow-400 font-bold text-sm">
                                Edit
                            </a>

                            <form method="POST" action="{{ route('petugas.books.destroy', $b) }}"
